...
**Документація:** [огляд продукту](docs/PROJECT_OVERVIEW.md) · [контекст розробки](docs/DEVELOPMENT_CONTEXT.md) · [оцінка vs ДАХ](docs/PROJECT_EVALUATION.md) · [дорожня карта](docs/TODO_ROADMAP.md) · [Android APK](mobile/README.md).

...
Реєстрація: **власник чи орендар** (`tenancyType`). Голосування та теми форуму мають поле **аудиторії** (усі / лише власники / лише орендарі); голова й модератор бачать усе. Окремої ролі «адмін платформи» поки немає — панель `/chair` для голови та модератора ОСББ. При цьому **голова** створює новини/голосування та керує балансом, а **модератор** керує користувачами і модерує (без зміни балансу та без створення новин/голосувань).
